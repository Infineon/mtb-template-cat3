# ModusToobox CAT3 BSP Template Library

## Overview

mtb-template-cat3 provides BSP template files for the BSP Assistant tool. mtb-template-cat3 contains files for the following devices:
